...
def train_model_with_sift():
    ...
    X_train, X_test, y_train, y_test = preprocess_data_with_sift('D:/CV/dataset/0', 'D:/CV/dataset/1')
    ...
    with open('D:\CV\Models_and_scalers\sift_svm_model.pkl', 'wb') as f:
        pickle.dump(svm, f)
    with open('D:\CV\Models_and_scalers\scaler_SIFT.pkl', 'wb') as f:
