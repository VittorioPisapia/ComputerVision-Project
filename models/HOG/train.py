...
def train_model():
    ...
    with open('C:\\Users\\Tommaso\\Documents\\GitHub\\ComputerVision-Project\\Models_and_scalers\hog_svm_model.pkl', 'wb') as f:
        pickle.dump(svm, f)
    with open('C:\\Users\\Tommaso\\Documents\\GitHub\\ComputerVision-Project\\Models_and_scalers\scaler_HOG.pkl', 'wb') as f:
