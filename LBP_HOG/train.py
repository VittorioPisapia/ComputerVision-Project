...
def train_model_with_lbp_hog():
    ...
    X_train, X_test, y_train, y_test = preprocess_data_with_lbp_hog('D:/CV/dataset/0', 'D:/CV/dataset/1')
    ...
    with open('D:\CV\Models_and_scalers\lbp_hog_svm_model.pkl', 'wb') as f:
        pickle.dump(svm, f)
    with open('D:\CV\Models_and_scalers\scaler_LBP_HOG.pkl', 'wb') as f:
